...
struct RendimentoMaterieSecondGem: View {
    ...
    var body: some View {
        VStack
        {
            ...
            Text("Score : 86%").font(.custom("Hanuman-Black",size:15.0)).foregroundStyle(.white)
        ...
        }.frame(width:190,height:175,alignment:.center).background(Color(uiColor: UIColor(red: 0.30, green: 0.31, blue: 0.20, alpha: 1.00))).cornerRadius(20)
    }
}
